...
public class SimpleExampleFromDocs {
    ...
    public SimpleExampleFromDocs(int numRecords,
                                 boolean doInsert,
                                 File envDir,
                                 int offset) {
    ...
    public static void main(String argv[]) throws Exception {
        ...
        try {
            SimpleExampleFromDocs app = new SimpleExampleFromDocs(numRecordsVal,
                                                  doInsertArg,
                                                  envHomeDirectory,
                                                  startOffset);
            app.run();
